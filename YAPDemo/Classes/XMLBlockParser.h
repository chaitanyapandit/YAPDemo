...
typedef void (^XMLParserBeginElementBlock)(NSString *elementName, NSDictionary *attributeDict);

/// The `typedef` for the block to be called in `didEndElement`, returning the characters received in `foundCharacters`.

typedef void (^XMLParserEndElementBlock)(NSString *elementName, NSDictionary *attributes, NSString *value);
typedef void (^XMLParserFoundCharactersBlock)(NSString *elementName, NSString *characters);
...
@property (nonatomic, copy) XMLParserFoundCharactersBlock foundCharactersBlock;
